...
VtxSmeared.MaxY = cms.double(150)              # NO EFFECT
VtxSmeared.MaxZ = cms.double(30)               # NO EFFECT
VtxSmeared.MaxT = cms.double(30 / 29.9792458)  # NO EFFECT
...
VtxSmeared.VtxSpectrum = cms.string('flatD0')
